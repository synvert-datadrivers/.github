...
Default files for [@synvert-datadrivers](https://github.com/synvert-datadrivers) repositories.

GitHub will use and display default files for any public repository in [@synvert-datadrivers](https://github.com/synvert-datadrivers) organization that does not have its own file of that type in any of the following places:
